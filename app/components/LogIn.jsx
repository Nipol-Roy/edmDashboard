    ...
    >
            ...
            <div className="w-[80%] h-[90%] relative ">
              ...
              <div className="py-3 flex justify-between items-center">
                <div className="text-white">
                  <input type="checkbox" className="outline-none " /> Remember
                  Me
                </div>
      ...
      <div className={`${registration === true ? "flex" : "hidden"}  `}>
        <div className="w-full h-full absolute top-0 left-0 login">
          <Image
            src={bgImage}
            alt="registration background page"
            className="w-full  h-full object-cover object-center"
          />
        </div>
        <div className="w-full  h-screen z-5 flex flex-col md:flex-row justify-start md:justify-center items-center">
          <div className="w-full md:w-1/2 md:border-r md:border-dashed md:border-white h-[20%] flex justify-center items-center md:h-full">
          ...
          <div className="w-full md:w-1/2  h-[80%]  md:h-full flex justify-center items-center ">
            <div className="w-[96%] h-[96%] relative   bg-(--lcbtn) rounded-md flex justify-center items-center">
              <div className="w-100 relative h-175  bg-(--dcbtn) rounded-md overflow-hidden   xl:w-125 xl:h-200  ">
                ...
                <div className="flex flex-col p-2">
                  ...
                  <div className="flex rounded-md justify-between items-center bg-white">
                    <input
                ...
                <div className="grid  relative grid-cols-3 ">
                  ...
                  <div className="h-full w-full text-sm  col-span-1 flex-col   flex justify-center items-center  py-1">
                    ...
                    <div className="text-white py-2">Profile Image</div>
                    <input
                      type="file"
                      accept="image/*"
                      id="profileImage"
