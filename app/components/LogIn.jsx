    ...
    <div className="w-full login flex justify-center items-center h-screen  relative ">
      <div className="w-full h-full absolute top-0 left-0">
        <Image
          src={bgImage}
          alt="background"
          className="object-cover w-full min-h-screen h-full object-center"
        />
      </div>
...
//  <div className="w-full   relative  p-3   flex justify-center items-center overflow-auto">
...
//              md:-translate-y-2/3  border border-black text-white w-full gap-2"
//           >
//             <div className="flex  justify-center  items-center gap-2">
//               <div className="text-5xl   h-15 rounded-2xl overflow-hidden w-15">
//                 <Image
