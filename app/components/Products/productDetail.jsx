...
import loadingImage from "../../../public/data/images/loadingImages.jpg";
...
const productDetail = ({ product }) => {
  ...
  return (
    <div className="w-full  flex justify-center items-center  py-10  bg-(--dcmbg)">
      <div>
        <div className="w-[90vw] relative xl:w-[70vw] bg-(--dcsbg) rounded-md">
          ...
          <div>
                ...
                <div className="flex items-center">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-md text-(--dcmb)">
                        Return Policy
                      </span>
                    </div>
                    <p className="ml-10 text-sm text-white">
            ...
            <div className="flex  justify-start relative flex-col sm:flex-row items-center gap-2 px-3 mb-3 w-full">
              ...
              {/* review message */}
              <div className="w-full h-52 p-1 sm:w-1/2 flex flex-col gap-1 bg-(--dcmbg) rounded-lg shadow-xl border border-slate-800">
                {/* Slider */}
